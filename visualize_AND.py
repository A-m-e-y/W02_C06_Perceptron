...
from Simple_Perceptron_AND import Perceptron

def main():
    # Fixed 2-input AND gate
    X = np.array([
        [0, 0],
        [0, 1],
        [1, 0],
    ...
    ax.set_title("Learning AND: Perceptron Decision Boundary")
    ...
    gif_filename = "AND_perceptron_animation.gif"
