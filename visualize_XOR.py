...
from Simple_Perceptron_XOR import Perceptron

def main():
    # Fixed 2-input XOR gate
    X = np.array([
        [0, 0],
        [0, 1],
        [1, 0],
    ...
    ax.set_title("Learning XOR: Perceptron Decision Boundary")
    ...
    gif_filename = "XOR_perceptron_animation.gif"
