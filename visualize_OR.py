...
from Simple_Perceptron_OR import Perceptron

def main():
    # Fixed 2-input OR gate
    X = np.array([
        [0, 0],
        [0, 1],
        [1, 0],
    ...
    ax.set_title("Learning OR: Perceptron Decision Boundary")
    ...
    gif_filename = "OR_perceptron_animation.gif"
